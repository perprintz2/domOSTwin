...
function init_Sim(id) {
    ...
    widgetsSim.push(new Thermo('EnergyRoad1', "Room1 Temp",           73*scale,      130*scale,     size, DynColor, 15, 30));
    widgetsSim.push(new NumDisplay('EnergyRoad1',"Room1 Temp",        (73 + 60)*scale, 130*scale,      42*scale, -10, 40));
    widgetsSim.push(new Thermo('EnergyRoad1', "Room1TempSim",        223*scale,      130*scale,     size, DynColor, 15, 30));
    widgetsSim.push(new NumDisplay('EnergyRoad1',"Room1TempSim",     (223 + 60)*scale, 130*scale,      42*scale, -10, 40));
    widgetsSim.push(new Thermo('EnergyRoad1', "Room1 TempNN",        373*scale,      130*scale,     size, DynColor, 15, 30));
    widgetsSim.push(new NumDisplay('EnergyRoad1',"Room1 TempNN",     (373 + 60)*scale, 130*scale,      42*scale, -10, 40));
}
...
function draw_logo(ctx, id) {
    ...
    var imageObjGui = new Image();
    var imageObjDT = new Image();
    //var imageMix = new Image();
    //arp = apartmentList.get('EnergyRoad1');
    ...
    imageObjGui.onload = function () {
        //ctx.clearRect(0, 0, 900, 600);
         ...
         //ctx.font = "bold " + 11 + "px Arial";
         ctx.fillStyle = "#000000";
         ctx.fillText(": Simulated version of the real house. (Neural Network based)", 230*scale,    83*scale,);
         ctx.fillText("- Click on the individual meter in the top right window", 70*scale,    163*scale,);
         ctx.fillText("to display the graph in the window below.", 85*scale,    193*scale,);
         ctx.fillText("- Click on the houses in the top left window", 70*scale,    463*scale,);
         ctx.fillText("to select the individual house.", 85*scale,    493*scale,);
         ctx.stroke();
        ctx.drawImage(imageObjGui, 85*scale, 230*scale, 460*scale, 179*scale);
    };
    imageObjAau.onload = function () {
       
        ctx.drawImage(imageObjAau, 690*scale, 520*scale, 200*scale, 50*scale);
    };
    imageObjDT.onload = function () {
       
        ctx.drawImage(imageObjDT, 50*scale, 10*scale,170*scale, 107*scale);
    };
    imageObjNeogrid.src = './images/Neogrid-Logo-16d18128.png';
    imageObjAau.src = './images/__AAU_LEFT_RGB_UK.png';
    imageObjGui.src = './images/Uuide1.png';
    imageObjDT.src = './images/Digital_Twin_Explainer.png';
}
...
function init_apartment_data_R13sim(id) {
...
function draw_apartment_gui_R13sim(ctx, id) {
    ...
    imageObj.onload = function () {
        ...
        ctx.font = "24.5px Times New Roman";
        ctx.fillStyle = "#000000";
        ctx.fillText(id+": -- Simulated temperatures --", 15*scale, 27*scale);
        ctx.font = "bold " + 11 + "px Arial";
        ctx.fillStyle = "#000000";
...
function init_apartment_data_R63Asim(id) {
    arp = apartmentList.get(id);
    addDepDataSt(id)
...
function draw_apartment_gui_R63Asim(ctx, id) {
...
function init_apartment_data_R77sim(id) {
    arp = apartmentList.get(id);
    addDepDataSt(id)
...
function draw_apartment_gui_R77sim(ctx, id) {
